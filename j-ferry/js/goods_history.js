...
function ChangeButton(leaveHistory) {
    ...
    if (leaveHistory == 1) {
        ...
        buttonspan = jQuery("<a href=\"javascript:void(0);\" class=\"item_history_link_\">—š—ð‚ðŽc‚·</a>");
        buttonspan.bind("click", DisplayCookie);
    }
    else {
        buttondiv.find("a").remove();
        buttonspan = jQuery("<a href=\"javascript:void(0);\" class=\"item_history_link_\">—š—ð‚ðŽc‚³‚È‚¢</a>");
